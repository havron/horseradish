"""
.. module: horseradish.plugins.base.v1
    :platform: Unix
...
class IPlugin(local):
    ...
    >>> from horseradish.plugins import Plugin
    >>>
    ...
    def get_resource_links(self):
        ...
        >>> def get_resource_links(self):
        >>>     return [
        >>>         ('Documentation', 'https://horseradish.readthedocs.io'),
        >>>         ('Bug Tracker', 'https://github.com/havron/horseradish/issues'),
        >>>         ('Source', 'https://github.com/havron/horseradish'),
        >>>     ]
        """
