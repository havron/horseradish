"""
.. module: horseradish.plugins.views
    :platform: Unix
...
from horseradish.schemas import plugins_output_schema, plugin_output_schema
from horseradish.common.schema import validate_schema
from horseradish.plugins.base import plugins
