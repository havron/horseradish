"""
.. module: horseradish.common.schema
    :platform: unix
...
class HorseradishSchema(Schema):
    """
...
class HorseradishInputSchema(HorseradishSchema):
...
class HorseradishOutputSchema(HorseradishSchema):
    @pre_load(pass_many=True)
    def preprocess(self, data, many):
        if many:
